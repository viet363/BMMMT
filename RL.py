...
class NetworkIntrusionEnv(gym.Env):
    def __init__(self):
        ...
        self.state_size = 10  # Số lượng đặc trưng trạng thái
        self.action_size = 4  # 4 hành động: không làm gì, chặn IP, cảnh báo, cập nhật firewall
    ...
    def step(self, action):
        ...
        action_labels = ["Không làm gì", "Chặn IP", "Gửi cảnh báo", "Cập nhật firewall"]
        ...
        print(f"Hành động: {action_labels[action]}, Phần thưởng: {reward}")
